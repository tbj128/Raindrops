	...
	foreach ($msg_id_to_list as $msg_id_to_id) {
		...
		if (isset($_POST['audio_location'])) {
			if ($_POST['audio_location'] != "") {
				...
				copy('../upload/audio/' . $msg_link, '../messages/' . $msg_id_to . '/' . $msg_link);
			}
		}
