...
<html lang="en">
  <head>
    ...
    <title>Raindrops Add Document</title>
          ...
          <div class="col-lg-8 center">
			...
			<div class="well center">
			  <!-- Check PHP; Add form validation -->
					<form id="document-form" method="post" action="includes/add_document.php?p=<?php echo $p;?>">
						<div class="form-group">
							<label>Document Name</label>
							<input type="hidden" name="document_parent_id" value="<?php echo $id; ?>">
							<input class="form-control" name="document_name" placeholder="Document Name" minlength="4" >
						</div>
						<div class="form-group">
							<label>
								<input type="checkbox" name="document_is_activity"> <small>Is Activity Item</small>
						...
						<div class="form-group">
							...
							<textarea name="document_desc" class="form-control" rows="3"></textarea>
						</div>
						<div class="form-group">
							...
							<input type="hidden" name="document_requires" id="requires-list" value="">
						...
						<div id="editor">
							<strong>Add images and text here.</strong> Format using the buttons above.
						</div>
						<input type="hidden" value="" name="document_text" id="document-text">
						
						<hr />
						<p><button type="button" id="btn-submit-continue" class="btn btn-primary">Continue</button></p>
					</form>
			</div>
