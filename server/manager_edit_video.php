...
<html lang="en">
  <head>
    ...
    <title>Raindrops Edit Video</title>
          ...
          <div class="col-lg-6 center">
			...
			<div class="well center">
			  <!-- Check PHP; Add form validation -->
					<form method="post" action="includes/edit_video.php?p=<?php echo $p;?>">
						<div class="form-group">
							<label>Video Name</label>
							<input type="hidden" name="video_id" value="<?php echo $id; ?>">
							<input class="form-control" name="video_name" placeholder="Video Name" minlength="4" value="<?php echo $item['name']; ?>">
						</div>
						<div class="form-group">
							<label>
								<input type="checkbox" name="video_is_activity" <?php if ($item['activity'] == "true") { echo 'checked'; } ?>> <small>Is Activity Item</small>
						...
						<div class="form-group">
							...
							<textarea name="video_desc" class="form-control" rows="3"><?php echo $item['desc']; ?></textarea>
						</div>
						<div class="form-group">
							<?php
							...
							<input type="hidden" name="video_requires" id="requires-list" value="<?php echo implode(",", $requiredItems); ?>">
							
						</div>
						<div class="form-group">
							<label>Upload Video</label><br />
							<input class="input" type="hidden" name="video_path_edited" id="videoPathEdited" value="0">
							<input class="input" type="hidden" name="video_path" id="videoPathHidden" value="">
							<input type="text" id="videoPath" value="<?php echo $item['source']; ?>" disabled><a id="deleteExistingVideo" style="display:none;cursor:pointer;font-size:28px;color:#999999;margin-left:20px;text-decoration:none;vertical-align:middle;">&times;</a>
						...
						<hr />
						<p><input type="submit" class="btn btn-primary" role="button" value="Save"></p>
					</form>
			</div>
