...
<html lang="en">
  <head>
    ...
    <title>Raindrops Edit Subfolder</title>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-6 center">
            <h1>Edit Subfolder <small></small></h1>
          </div>
        </div><!-- /.row -->
          ...
          <div class="col-lg-6 center">
			...
			<div class="well center">
			  <!-- Check PHP; Add form validation -->
					<form method="post" action="includes/edit_submenu.php?p=<?php echo $p;?>">
						<div class="form-group">
							<label>Folder Name</label>
							<input type="hidden" name="menu_id" value="<?php echo $item['id']; ?>">
							<input class="form-control" name="menu_name" value="<?php echo $item['name']; ?>" >
						</div>
						<div class="form-group">
							<label>Description</label>
							<textarea name="menu_desc" class="form-control" rows="3"><?php echo $item['desc']; ?></textarea>
						</div>
						<div class="form-group">
							...
							<input type="hidden" name="menu_requires" id="requires-list" value="<?php echo implode(",", $requiredItems); ?>">
