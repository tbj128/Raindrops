...
public class AnimStars {
     ...
     */
    static AnimStars createFlake(float xRange, float yRange, Bitmap originalBitmap) {
        AnimStars flake = new AnimStars();
        ...
        flake.speed = 400 + (float) Math.random() * 1200;
        flake.xspeed = -300 + (float) Math.random() * 600;
